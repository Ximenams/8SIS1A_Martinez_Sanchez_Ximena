...
function descuento(){
    ...
    document.formulario.descuento.value="$"+valorPagar;
}
...
function porcentaje{
    ...
    porcjtHombres=(parseInt(numAlumnos)*parseInt(numHombres))/100;
    porcjtMujeres=(parseInt(numAlumnos)*parseInt(numMujeres))/100;
}